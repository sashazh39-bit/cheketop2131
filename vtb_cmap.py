...
_CID_CYRILLIC = {
    ...
    "Е": "0221", "Ж": "0222", "З": "0243", "И": "0224", "Й": "0225",
    # К/Л/М/Н/Р uppercase: GID=0 в базовом шрифте — slot-replacement даёт донорский глиф
    # Н=0229 (отдельная позиция заглавной в диапазоне 021C+, GID=37 у донора)
    # Не путать с н=0249 (строчная) и H=0249 в _CID_OPID (визуально H)
    "К": "0226", "Л": "0227", "М": "0228", "Н": "0229", "О": "024A",
    "П": "022B", "Р": "022C", "С": "022D", "Т": "022E", "У": "024F",
    # И=0224 (правильная позиция заглавной, GID>0 в базе — не нужна инъекция)
    # Й=0225, Ф=0230 (GID=0 в базе → инъекция, как М/Н/К)
    # Х=0251 (исправлено: было 0231→GID0), Ц=0252 (было 0247=л!)
    "Ф": "0230", "Х": "0251", "Ц": "0252",
    "Ч": "0253", "Ш": "0254", "Щ": "0255", "Ъ": "0256", "Ы": "0257",
    "Ь": "0258", "Э": "0242", "Ю": "023A", "Я": "023B",
    # Я=023B (правильная позиция заглавной в диапазоне 021C+, GID=0 в базе, GID=55 у донора)
